...
def plotData(X, y):
    ...
    pyplot.scatter(X[pos, 0], X[pos, 1], s=30, c='darkblue', marker='+')
    pyplot.scatter(X[neg, 0], X[neg, 1], s=30, c='yellow', marker='o', edgecolors='b')

 


    
    pst = pyplot.legend(loc='upper right', frameon=True)
...
def costFunction(theta, X, y):
    ...
    J = - (np.dot(y, np.log(hThetaX)) + np.dot((1 - y), np.log(1 - hThetaX ))) / m
...
def costFunctionReg(theta, X, y, lambda_):
    ...
    grad =  (np.dot(X.T, (hThetaX - y)) + lambda_) / m
    # =============================================================
    return J, grad
